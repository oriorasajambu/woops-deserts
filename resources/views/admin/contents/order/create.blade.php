<div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modal-create-order">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bg-light">
            <div class="modal-header">
                <h5 class="modal-title">@lang('order.modal.add')</h5>
            ...
            <div class="modal-footer pb-0">
                ...
                <button type="submit" wire:click.prevent="store" class="btn bg-gradient-success">@lang('order.button.add')</button>
            </div>
        </div>
    </div>
</div>
