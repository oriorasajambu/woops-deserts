<div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modal-edit-product">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div id="modal-edit-product" class="modal-content bg-light">
            <div class="modal-header">
                <h5 class="modal-title">@lang('product.modal.edit')</h5>
            ...
            <div id="modal-body-form" class="modal-body">
                <div class="input-group input-group-static mb-4">
                    ...
                    <select wire:model.defer="category_id" class="form-control" id="category" name="category">
                        <option value="">@lang('product.category')</option>
            ...
            <div class="modal-footer pb-0">
                ...
                <button type="submit" wire:click.prevent="edit" class="btn bg-gradient-success">@lang('product.button.edit')</button>
            </div>
        </div>
    </div>
</div>
